...
statement: rolePolicy | rulePolicy;

rolePolicy: identifier COLON expression (constraints)?;

rulePolicy: identifier COLON granularities (encryptor)?;

expression: name | identifier | literal;

encryptor: ENCRYPTEDBY identifier (OR identifier)*;
...
granularities: TBO granularity (COMA granularity)* TBC;

granularity: expression (constraints)?;
